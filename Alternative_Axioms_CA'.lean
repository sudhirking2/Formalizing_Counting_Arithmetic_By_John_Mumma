...
class CountingArithmetic (I S : Type u)
  ...
  I6 : ∀ i j k l : I, pr i j = pr k l → i=k
  I7 : ∀ i j k l : I, pr i j = pr k l → j=l
...
@[simp]
lemma I6' :
  ∀ i j k l : I, ⟪i, j⟫ = ⟪k, l⟫ → i = k := I6

@[simp]
lemma I7' :
  ∀ i j k l : I, ⟪i, j⟫ = ⟪k, l⟫ → j = l :=  I7
...
theorem pair_left_injective : ∀ i j k l : I, ⟪i, j⟫ = ⟪k, l⟫ → i = k := I6


theorem pair_right_injective : ∀ i j k l : I, ⟪i, j⟫ = ⟪k, l⟫ → j = l := I7
